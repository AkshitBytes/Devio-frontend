...
export default function TeacherDashboard() {
  ...
  // Demo classroom data
  const CLASSES = [
    { name: "CS301 - Algorithms", code: "ALG7X2", students: 32, active: true, battles: 8 },
    { name: "CS201 - Data Structures", code: "DS4K9M", students: 28, active: false, battles: 5 },
    { name: "CS401 - Competitive Prog.", code: "CP2R7N", students: 24, active: true, battles: 12 },
  ];
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
          <section className="xl:col-span-2 panel p-5">
            ...
            <div className="space-y-3">
              {CLASSES.map((cls, i) => (
                <div key={i} className="panel-soft p-3 flex items-center gap-3">
                  <div className="flex-1">
                    <div className="font-semibold">{cls.name}</div>
                    <div className="text-xs text-slate-400">{cls.students} students · {cls.battles} battles</div>
                  </div>
                  ...
                  <button className="btn-muted !py-2 !px-3"><Eye className="w-4 h-4" /></button>
          ...
          <div className="w-full max-w-md p-8 rounded-[32px]"
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-3 mt-2">
                ...
                <button onClick={() => { alert("Class creation would call the backend here."); setShowCreateModal(false); }}
